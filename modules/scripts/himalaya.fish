...
complete -c himalaya -n "__fish_use_subcommand" -f -a "accounts" -d 'Lists accounts'
...
complete -c himalaya -n "__fish_use_subcommand" -f -a "sort" -d 'Sorts messages by the given criteria and matching the given IMAP query'
...
complete -c himalaya -n "__fish_seen_subcommand_from accounts" -s w -l max-width -d 'Defines a maximum width for the table'
complete -c himalaya -n "__fish_seen_subcommand_from accounts" -s h -l help -d 'Prints help information'
complete -c himalaya -n "__fish_seen_subcommand_from accounts" -s V -l version -d 'Prints version information'
...
complete -c himalaya -n "__fish_seen_subcommand_from sort" -s s -l size -d 'Page size'
complete -c himalaya -n "__fish_seen_subcommand_from sort" -s p -l page -d 'Page number'
complete -c himalaya -n "__fish_seen_subcommand_from sort" -s w -l max-width -d 'Defines a maximum width for the table'
complete -c himalaya -n "__fish_seen_subcommand_from sort" -s c -l criterion -d 'Defines the message sorting preferences' -r -f -a "arrival arrival:asc arrival:desc cc cc:asc cc:desc date date:asc date:desc from from:asc from:desc size size:asc size:desc subject subject:asc subject:desc to to:asc to:desc"
complete -c himalaya -n "__fish_seen_subcommand_from sort" -s h -l help -d 'Prints help information'
complete -c himalaya -n "__fish_seen_subcommand_from sort" -s V -l version -d 'Prints version information'
...
complete -c himalaya -n "__fish_seen_subcommand_from read" -s h -l header -d 'Shows additional headers with the message'
complete -c himalaya -n "__fish_seen_subcommand_from read" -s r -l raw -d 'Reads raw message'
complete -c himalaya -n "__fish_seen_subcommand_from read" -l help -d 'Prints help information'
